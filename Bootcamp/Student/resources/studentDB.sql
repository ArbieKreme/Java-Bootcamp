...
CREATE TABLE `student_subjects` (
  ...
  KEY `FKgfh1m8j4wxapkva7cwgi30wu6` (`subject_id`),
  KEY `FKlcmxo19kkhwdmk263520p0r2i` (`student_id`),
  CONSTRAINT `FKlcmxo19kkhwdmk263520p0r2i` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`),
  CONSTRAINT `FKgfh1m8j4wxapkva7cwgi30wu6` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-10-31 10:23:19
