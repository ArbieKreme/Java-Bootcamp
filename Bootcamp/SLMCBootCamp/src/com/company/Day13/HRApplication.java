...
public class HRApplication {
  public static void main(String[] args){
    ...
    ad1.setHseUnitNo("67F"); ad1.setStreetCity("Tramo St."); ad1.setProvince("Rizal"); ad1.setZipCode("1300");
    a.setAddress(ad1);
    ...
    ad2.setHseUnitNo("343"); ad2.setStreetCity("Malapantao St."); ad2.setProvince("MM"); ad2.setZipCode("1310");
    b.setAddress(ad2);
    ...
    ad3.setHseUnitNo("Lot 5 Blk2"); ad3.setStreetCity("Pleasant View Subvd."); ad3.setProvince("Rizal"); ad3.setZipCode("1301");
    c.setAddress(ad3);
    ...
    ad4.setHseUnitNo("56"); ad4.setStreetCity("Shaw Blvd."); ad4.setProvince("MM"); ad4.setZipCode("1320");
    d.setAddress(ad4);
    ...
    ad5.setHseUnitNo("No. 11/E"); ad5.setStreetCity("Towers Condo."); ad5.setProvince("Laguna"); ad5.setZipCode("1200");
    e.setAddress(ad5);
    ...
    ad6.setHseUnitNo("Unit 4/Bldg 3"); ad6.setStreetCity("Mansions Haven"); ad6.setProvince("Laguna"); ad6.setZipCode("1200");
    f.setAddress(ad6);
    ...
    ad7.setHseUnitNo("1A"); ad7.setStreetCity("Burgos Circle"); ad7.setProvince("MM"); ad7.setZipCode("1230");
    g.setAddress(ad7);
    ...
    ad8.setHseUnitNo("1A"); ad8.setStreetCity("Burgos Circle"); ad8.setProvince("MM"); ad8.setZipCode("1201");
    h.setAddress(ad8);
    repository.addPerson(h);

    repository.sortRepositoryByLastName();
    repository.sortRepositoryByProvince();
    repository.sortRepositoryByZipCode();
